...
import { deployIndexController, deployIndexWorker, deployRunController, deployRunWorker, telemetryEntryPoint, } from "../build/packageModules.js";
...
async function _deployCommand(dir, options) {
    ...
    outro(`Version ${version} deployed with ${taskCount} detected task${taskCount === 1 ? "" : "s"} | ${deploymentLink} | ${testLink}`);
}
